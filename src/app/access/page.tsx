          ...
          <FadeIn direction="up" className="flex flex-col gap-4">
            <div className="relative h-[320px] sm:h-[450px] bg-brand-bg border border-brand-border/40 overflow-hidden group">
              ...
              <div className="hidden sm:block absolute bottom-4 left-4 bg-white/90 backdrop-blur-md px-5 py-4 border border-brand-border/50 shadow-sm max-w-[280px]">
                <span className="font-serif text-sm font-light tracking-widest text-brand-text block mb-2">
                  miamio Salon Map
                </span>
                <a
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="sm:hidden block w-full text-center border border-brand-accent py-3 text-[10px] font-light tracking-[0.2em] text-brand-accent hover:bg-brand-accent hover:text-white transition-colors"
            >
              GOOGLE MAP でルートを確認する
            </a>
          </FadeIn>
