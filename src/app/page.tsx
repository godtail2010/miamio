            ...
            {[
              {
                ...
                price: "¥6,000",
                time: "60 min",
                desc: "うるつやトリートメント付◎ エクステよりも自然に、自分のまつ毛を根元からしっかり立ち上げてぱっちりとした目元に。",
                img: IMAGES.menu1,
              },
              {
                title: "極柔フラットラッシュ 120本",
                price: "¥6,100",
                time: "75 min",
                desc: "当サロン一番人気のマツエクメニュー！印象的な目元にしたい方にオススメです。仕上げのコーティング剤無料サービス付き。",
                img: IMAGES.menu2,
              },
              {
                title: "ブロウリフトワックス",
                price: "¥5,900",
                time: "60 min",
                desc: "【眉パーマ＋眉ワックス】次世代眉パーマで毛流れを整え、ワックスで産毛を取り除く大人気のアイブロウメニューです。",
                img: IMAGES.hero,
              },
            ].map((menu, i) => (
